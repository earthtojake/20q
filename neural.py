...
class NeuralNetwork:
    ...
    def __init__(self, num_inputs=0, num_hidden=0, num_outputs=0, loadfile=None,learning_rate = 0.01, hidden_layer_weights = None, hidden_layer_bias = None, output_layer_weights = None, output_layer_bias = None):

        # if loadfile:
        #     with open(loadfile,"w") as infile:
    ...
    def save(self,filename):
        ...
        try:
            with open(filename,"w") as outfile:
                ...
                data['num_outputs'] = len(self.hidden_layer.neurons)
